...
import com.pianostudy.listener.ButtonTouchListener;
...
public class ButtonActivity extends Activity implements View.OnClickListener {
	...
	private void initSound() {
		...
		this.soundPool = new SoundPool(25, 3, 5);// 同时播放的最大数量，流的类型，采样率转化质量
		// soundPool.load(this, 2130968588, 1);//上下文，音源文件位置，1
