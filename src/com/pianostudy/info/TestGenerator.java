...
public class TestGenerator {
	...
	public final int maxonenote = 25; // ¸ÖÇÙ¼üÊýÁ¿
	public short onenote[] = new short[maxonenote];
	public short blacknum_onenote[] = new short[maxonenote]; // ÊÇ·ñºÚ¼ü
	...
	private void init_onenote() {
		...
		// initialize level 1£¬µ¥Òô£¬°×¼ü
		for (int i = 0; i < maxonenote; i++) {
			num = num + blacknum_onenote[i];
		}
		numoflev[0] = maxonenote - num; // °×¼üÊýÁ¿
		numoflev[1] = num; // ºÚ¼üÊýÁ¿
